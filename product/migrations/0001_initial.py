# Generated by Django 4.2 on 2023-08-19 13:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='produts', verbose_name='Image')),
                ('price', models.FloatField(max_length=20, verbose_name='Price')),
                ('sku', models.CharField(max_length=12, verbose_name='SKU')),
                ('subtitle', models.TextField(max_length=40000, verbose_name='Subtitle')),
                ('description', models.TextField(max_length=400000, verbose_name='Description')),
